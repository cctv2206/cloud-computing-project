...
/**
 * 
 * This is DB code that is used to interface with the DB.
 * The Twitter code written in get_tweets and parse_tweets need to
 * create an instance of this class to do their work with the DB.
 *  *   
